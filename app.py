...
*   **[Nicolas Turpin](https://github.com/NicGitT)** 
""")
...
st.write("Après avoir rempli le formulaire, appuyez sur le bouton pour votre score, probabilité de défaut et la décision de la banque.")
